...
| --- | --- | ---: | ---: | ---: |
| `01-chorus-pad.wav` | Saw and sub through the mode-I chorus: the classic pad, hiss and all | 21.9 s | −12.4 dBFS | +9.4 dB |
| `02-pwm-strings.wav` | Pulse-width-modulated strings in the faster mode-II chorus | 15.3 s | −12.7 dBFS | +9.7 dB |
| `03-sixteen-foot-bass.wav` | A 16' bassline: the exponential envelope segments doing the punch | 13.8 s | −23.8 dBFS | +20.8 dB |
| `04-filter-brass.wav` | Resonant filter-envelope stabs, ending on a full bender push | 10.3 s | −22.3 dBFS | +19.3 dB |
| `05-self-oscillation.wav` | The filter played as a voice at full resonance and key follow | 12.9 s | −22.8 dBFS | +19.8 dB |
| `06-chorus-modes.wav` | The same pad with the effect off, in mode I, mode II, then I+II | 20.5 s | −13.1 dBFS | +10.1 dB |
| `07-unison-glide.wav` | Six-voice unison lead with constant-rate portamento | 11.5 s | −8.1 dBFS | +5.1 dB |
...
| `10-unit-character.wav` | A six-voice chord at nominal zero Unit Character, then at full amount | 12.9 s | −19.0 dBFS | +16.0 dB |
<!-- peaks-table-end -->
...
*Low Sun* — D aeolian, 114 bpm, 103.2 s, 24-bit/44.1 kHz, 4x oversampled. Rendered mix peak +2.6 dBFS, normalised −5.6 dB.

| Part | Factory preset | Role | Max notes | Overdub gain | Rendered peak |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `A48` Synth Bass I (unison) | bass | 1 | +0.0 dB | −2.2 dBFS |
| 2 | `A67` Shaker | shaker | 1 | +9.0 dB | −10.0 dBFS |
| 3 | `A64` Snare Drum (unison) | snare | 1 | +6.0 dB | −2.8 dBFS |
| 4 | `A54` Funky II | stabs | 4 | +0.0 dB | −8.1 dBFS |
| 5 | `A28` Elect. Piano II | electric piano | 1 | +0.0 dB | −18.3 dBFS |
| 6 | `A11` Brass Set 1 | brass | 3 | +0.0 dB | −11.0 dBFS |
| 7 | `B11` Strings | strings | 3 | +0.0 dB | −13.7 dBFS |
| 8 | `A17` Choir | choir | 3 | +0.0 dB | −10.7 dBFS |
| 9 | `B13` Chorus Vibes | chorus vibes | 4 | +0.0 dB | −25.9 dBFS |
| 10 | `A53` Lead III | lead | 1 | +0.0 dB | −24.3 dBFS |
...
| [`A17`](Docs/audio/demo-A17-choir.wav) | Choir | Pad / Vocal | 22.1 s | −12.0 dBFS | +9.0 dB | Ethereal vocal wash with slow-blooming voice leading in D minor |
| [`A28`](Docs/audio/demo-A28-elect-piano-2.wav) | Elect. Piano II | Keyboards | 18.1 s | −10.1 dBFS | +7.1 dB | Warm chorused neo-soul progression with singing upper harmonics |
| [`A32`](Docs/audio/demo-A32-steel-drums.wav) | Steel Drums | Percussive | 10.4 s | −8.2 dBFS | +5.2 dB | Syncopated tropical calypso bounce and bright envelope strike |
| [`A48`](Docs/audio/demo-A48-synth-bass-unison.wav) | Synth Bass I (unison) | Bass | 10.3 s | −12.2 dBFS | +9.2 dB | Punchy 16th-note analog funk bassline driving with 6-voice unison bite |
| [`A53`](Docs/audio/demo-A53-lead-3.wav) | Lead III | Lead | 15.8 s | −24.5 dBFS | +21.5 dB | Singing solo synth lead with expressive portamento glides |
| [`A54`](Docs/audio/demo-A54-funky-2.wav) | Funky II | Pluck / Stab | 7.8 s | −9.7 dBFS | +6.7 dB | Resonant funk stab groove with dynamic envelope bounce in E Dorian |
| [`A62`](Docs/audio/demo-A62-clav.wav) | Clav | Pluck | 8.1 s | −14.2 dBFS | +11.2 dB | Crisp percussive 70s funk clavinet pattern in D Dorian |
| [`A68`](Docs/audio/demo-A68-synth-pad.wav) | Synth Pad | Pad | 24.0 s | −10.6 dBFS | +7.6 dB | Deep warm analog pad with slow filter bloom and moving inner voices |
| [`A86`](Docs/audio/demo-A86-hand-claps.wav) | Hand Claps | Percussive / FX | 7.5 s | −27.5 dBFS | +24.5 dB | Rhythmic analog noise burst claps in an 80s drum groove |
| [`B11`](Docs/audio/demo-B11-strings.wav) | Strings | Strings | 20.9 s | −11.7 dBFS | +8.7 dB | The iconic Juno PWM chorused strings with lush voice-led counterpoint |
| [`B13`](Docs/audio/demo-B13-chorus-vibes.wav) | Chorus Vibes | Mallet / Keys | 21.6 s | −12.2 dBFS | +9.2 dB | Shimmering vibraphone jazz chords and sparkling upward arpeggio |
...
| [`B33`](Docs/audio/demo-B33-lute.wav) | Lute | Pluck | 17.2 s | −30.4 dBFS | +27.4 dB | Baroque plucked string arpeggiation with natural acoustic damping in D minor |
| [`B44`](Docs/audio/demo-B44-contact-wah.wav) | Contact Wah | Filter / Mod | 8.1 s | −16.5 dBFS | +13.5 dB | Funky envelope-wah comping with dynamic rhythmic filter sweeps |
...
- The product carries the owner's four listening decisions of 2026-09-22
  ...
  - Chorus hiss: `ChorusNoiseCalibrationProfile::IdleFloor439522`
    ...
    captures of #439522, but the factor was measured through a boxcar
    window that leaked the hardware idle floors' sub-20 Hz drift into the
