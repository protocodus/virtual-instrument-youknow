...
| --- | --- | ---: | ---: | ---: |
| `01-chorus-pad.wav` | Saw and sub through the mode-I chorus: the classic pad, hiss and all | 21.9 s | −11.5 dBFS | +8.5 dB |
...
| `05-self-oscillation.wav` | The filter played as a voice at full resonance and key follow | 12.9 s | −25.0 dBFS | +22.0 dB |
...
| `09-high-pass-ladder.wav` | One bright chord through all four high-pass switch positions | 10.6 s | −11.1 dBFS | +8.1 dB |
...
*Low Sun* — D aeolian, 114 bpm, 103.2 s, 24-bit/44.1 kHz, 4x oversampled. Rendered mix peak +0.7 dBFS, normalised −3.7 dB.
...
| 4 | `A54` Funky II | stabs | 4 | +0.0 dB | −8.3 dBFS |
| 5 | `A28` Elect. Piano II | electric piano | 1 | +0.0 dB | −18.8 dBFS |
| 6 | `A11` Brass Set 1 | brass | 3 | +0.0 dB | −11.2 dBFS |
| 7 | `B11` Strings | strings | 3 | +0.0 dB | −13.3 dBFS |
| 8 | `A17` Choir | choir | 3 | +0.0 dB | −11.1 dBFS |
| 9 | `B13` Chorus Vibes | chorus vibes | 4 | +0.0 dB | −26.4 dBFS |
