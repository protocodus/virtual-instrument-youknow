...
| --- | --- | ---: | ---: | ---: |
| `01-chorus-pad.wav` | Saw and sub through the mode-I chorus: the classic pad, hiss and all | 21.9 s | −11.6 dBFS | +8.6 dB |
...
| `07-unison-glide.wav` | Six-voice unison lead with constant-rate portamento | 11.5 s | −8.6 dBFS | +5.6 dB |
| `08-delayed-vibrato.wav` | The modulator's two-stage delay fading vibrato onto a held chord | 9.6 s | −19.2 dBFS | +16.2 dB |
| `09-high-pass-ladder.wav` | One bright chord through all four high-pass switch positions | 10.6 s | −11.2 dBFS | +8.2 dB |
...
*Low Sun* — D aeolian, 114 bpm, 103.2 s, 24-bit/44.1 kHz, 4x oversampled. Rendered mix peak +1.2 dBFS, normalised −4.2 dB.

| Part | Factory preset | Role | Max notes | Overdub gain | Rendered peak |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `A48` Synth Bass I (unison) | bass | 1 | +0.0 dB | −3.1 dBFS |
...
| 8 | `A17` Choir | choir | 3 | +0.0 dB | −11.0 dBFS |
