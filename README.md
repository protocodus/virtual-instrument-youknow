...
- A straight Miller-integrator constant-current ramp with finite reset, a
  ...
  (`Tools/AnalyzeHardwarePwm.py`). Raw values above the physical travel
  remain accessible through the seven-bit patch format and pin the
  comparator high from byte 113. Pulse Off's documented −0.8 V hold
