...
- The CHORUS button does not reach the wet return at once. The jack-board
  ...
  loading. With the existing 0.6 V junction prior it mutes the wet return
  about 84.5 ms after CHORUS goes off and opens it about 113.2 ms after it
  comes on. An independent voltage-node RK4 reference agrees within 0.37 µV
  across the tested sample rates. The parts are anchored; Tr4 base-current
  effects and installed-unit switching times remain unmeasured.
