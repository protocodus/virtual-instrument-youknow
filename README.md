...
YouKnow does not transmit performance data or Program Changes.
...
through the same DSP engine used by the plug-in.
...
| --- | --- | ---: | ---: | ---: |
| `01-chorus-pad.wav` | Saw and sub through the mode-I chorus: the classic pad, hiss and all | 21.9 s | −10.3 dBFS | +7.3 dB |
...
| `06-chorus-modes.wav` | The same pad with the effect off, in mode I, mode II, then I+II | 20.5 s | −12.8 dBFS | +9.8 dB |
| `07-unison-glide.wav` | Six-voice unison lead with constant-rate portamento | 11.5 s | −8.0 dBFS | +5.0 dB |
| `08-delayed-vibrato.wav` | The modulator's two-stage delay fading vibrato onto a held chord | 9.6 s | −19.0 dBFS | +16.0 dB |
| `09-high-pass-ladder.wav` | One bright chord through all four high-pass switch positions | 10.6 s | −11.5 dBFS | +8.5 dB |
