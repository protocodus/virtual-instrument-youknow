...
- The CHORUS button does not reach the wet return at once. The jack-board
  ...
  through D4/D5. A one-way RC cascade approximation with a 0.6 V junction
  prior mutes the wet return about 81 ms after CHORUS goes off and opens it
  about 115 ms after it comes on. The parts are anchored; these nominal
  timings do not qualify the bidirectional loading or Tr4 base-current
  effects identified in the [research review](Docs/modeling-research-2026-09.md).
