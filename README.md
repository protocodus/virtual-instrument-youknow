...
archival tone transcription — comparison and bracket material, not
hash-pinned here); ModWiggler
...
- Two uncompanded 256-stage MN3009 lines driven anti-phase by one triangle
  ...
  designator-faithful build below the anchoring bar; OQ-01). The separate
...
| --- | --- | --- | ---: | ---: | ---: | --- |
| [`A11`](Docs/audio/presets/demo-A11-brass-set-1.wav) | Brass Set 1 | Poly Brass | 9.5 s | −10.0 dBFS | +7.0 dB | Syncopated 80s brass stabs and punchy fanfare cadence in B-flat |
| [`A17`](Docs/audio/presets/demo-A17-choir.wav) | Choir | Pad / Vocal | 22.1 s | −13.6 dBFS | +10.6 dB | Ethereal vocal wash with slow-blooming voice leading in D minor |
| [`A28`](Docs/audio/presets/demo-A28-elect-piano-2.wav) | Elect. Piano II | Keyboards | 18.1 s | −10.7 dBFS | +7.7 dB | Warm chorused neo-soul progression with singing upper harmonics |
...
| [`A48`](Docs/audio/presets/demo-A48-synth-bass-unison.wav) | Synth Bass I (unison) | Bass | 10.3 s | −13.5 dBFS | +10.5 dB | Punchy 16th-note analog funk bassline driving with 6-voice unison bite |
| [`A53`](Docs/audio/presets/demo-A53-lead-3.wav) | Lead III | Lead | 15.8 s | −23.6 dBFS | +20.6 dB | Singing solo synth lead with expressive portamento glides |
| [`A54`](Docs/audio/presets/demo-A54-funky-2.wav) | Funky II | Pluck / Stab | 7.8 s | −10.9 dBFS | +7.9 dB | Resonant funk stab groove with dynamic envelope bounce in E Dorian |
| [`A62`](Docs/audio/presets/demo-A62-clav.wav) | Clav | Pluck | 8.1 s | −18.0 dBFS | +15.0 dB | Crisp percussive 70s funk clavinet pattern in D Dorian |
| [`A68`](Docs/audio/presets/demo-A68-synth-pad.wav) | Synth Pad | Pad | 24.0 s | −9.3 dBFS | +6.3 dB | Deep warm analog pad with slow filter bloom and moving inner voices |
...
| [`B11`](Docs/audio/presets/demo-B11-strings.wav) | Strings | Strings | 20.9 s | −11.7 dBFS | +8.7 dB | The iconic Juno PWM chorused strings with lush voice-led counterpoint |
| [`B13`](Docs/audio/presets/demo-B13-chorus-vibes.wav) | Chorus Vibes | Mallet / Keys | 21.6 s | −10.6 dBFS | +7.6 dB | Shimmering vibraphone jazz chords and sparkling upward arpeggio |
| [`B31`](Docs/audio/presets/demo-B31-brass.wav) | Brass | Brass | 21.1 s | −12.7 dBFS | +9.7 dB | Warm, mellow brass chorale with gentle filter swells in F major |
| [`B33`](Docs/audio/presets/demo-B33-lute.wav) | Lute | Pluck | 17.2 s | −27.5 dBFS | +24.5 dB | Baroque plucked string arpeggiation with natural acoustic damping in D minor |
| [`B44`](Docs/audio/presets/demo-B44-contact-wah.wav) | Contact Wah | Filter / Mod | 8.1 s | −17.3 dBFS | +14.3 dB | Funky envelope-wah comping with dynamic rhythmic filter sweeps |
