...
// commit message.
//
//   YouKnowRenderFidelityFixes <outputDir> before
//   ... apply the fix ...
//   YouKnowRenderFidelityFixes <outputDir> after
//
...
int main(int argc, char** argv)
{
    ...
    if (comparing && !manifestRows.empty())
    {
        std::string manifest =
            ...
            "Generated by `YouKnowRenderFidelityFixes`, run once before a fix and\n"
